        ...
        <div v-for="(action, idx) in actions" :key="action.id" class="flex items-center gap-2 p-2 sm:p-3 border border-gray-100 dark:border-gray-800/60 bg-gray-50/50 dark:bg-gray-950/50">
          ...
          <div class="shrink-0 w-[120px] sm:w-[140px]">
            <CustomSelect v-model="action.type" :options="[
              ...
              {label: t('taskForm.botLink'), value:'bot_link'},
          ...
          <div class="flex-1 min-w-0">
            ...
            <input v-else-if="action.type === 'bot_link'" v-model="action.value" :placeholder="t('taskForm.botUsernamePlaceholder')" class="w-full h-9 px-2 text-xs border border-gray-200 dark:border-gray-800/60 bg-white dark:bg-gray-900 outline-none focus:border-gray-400" />
